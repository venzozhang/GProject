...
public:
  ...
  uint32_t GetLocalDensity ();

  void SetLocalDensity (uint32_t localDensity);

  void CalculateLocalDensity (uint32_t var);

  uint8_t CalculateTxPower ();
