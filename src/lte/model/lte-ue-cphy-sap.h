...
public:
  ...
  //********************************************************************************************************************************************
  virtual void UseD2DMode (bool flag, uint64_t targetImsi, uint16_t rnti) {}
//********************************************************************************************************************************************
...
template <class C>
void
MemberLteUeCphySapProvider<C>::UseD2DMode (bool flag, uint64_t targetImsi, uint16_t targetRnti)
{
  m_owner->DoUseD2DMode (flag, targetImsi, targetRnti);
}
