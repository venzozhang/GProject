...
//////////////////// D2DConnectionRequest class ////////////////////////

// Constructor
D2DConnectionRequestHeader::D2DConnectionRequestHeader () : RrcUlDcchMessage ()
{
  m_mmec = std::bitset<8> (0ul);
  m_mTmsi = std::bitset<32> (0ul);
...
// Destructor
D2DConnectionRequestHeader::~D2DConnectionRequestHeader ()
{
}

TypeId
D2DConnectionRequestHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::D2DConnectionRequestHeader")
    .SetParent<Header> ()
  ;
  return tid;
}
...
void
D2DConnectionRequestHeader::Print (std::ostream &os) const
{
  os << "MMEC:" << m_mmec << std::endl;
  os << "MTMSI:" << m_mTmsi << std::endl;
  os << "Spare: " << m_spare << std::endl;
...
void
D2DConnectionRequestHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();

  SerializeUlDcchMessage (13);

  // Serialize D2DConnectionRequest sequence:
  // no default or optional fields. Extension marker not present.
  SerializeSequence (std::bitset<0> (),false);

  // Serialize criticalExtensions choice:
  // 2 options, selected: 0 (option: D2DConnectionRequest-r8)
  SerializeChoice (2,0,false);

  // Serialize D2DConnectionRequest-r8-IEs sequence:
  // no default or optional fields. Extension marker not present.
  SerializeSequence (std::bitset<0> (),false);
...
uint32_t
D2DConnectionRequestHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<1> dummy;
  std::bitset<0> optionalOrDefaultMask;
  int selectedOption;
...
void
D2DConnectionRequestHeader::SetMessage (LteRrcSap::D2DConnectionRequest msg)
{
  m_mTmsi = std::bitset<32> ((uint32_t)msg.dstUeIdentity);
  m_mmec = std::bitset<8> ((uint32_t)(msg.dstUeIdentity >> 32));
  m_isDataSerialized = false;
}

LteRrcSap::D2DConnectionRequest
D2DConnectionRequestHeader::GetMessage () const
{
  LteRrcSap::D2DConnectionRequest msg;
  msg.dstUeIdentity = (((uint64_t) m_mmec.to_ulong ()) << 32) | (m_mTmsi.to_ulong ());

  return msg;
}

std::bitset<8>
D2DConnectionRequestHeader::GetMmec () const
{
  return m_mmec;
}

std::bitset<32>
D2DConnectionRequestHeader::GetMtmsi () const
{
  return m_mTmsi;
}
...
//////////////////// D2DConnectionSetup class ////////////////////////

// Constructor
D2DConnectionSetupHeader::D2DConnectionSetupHeader () : RrcUlDcchMessage ()
{
  m_mmec = std::bitset<8> (0ul);
  m_mTmsi = std::bitset<32> (0ul);
...
// Destructor
D2DConnectionSetupHeader::~D2DConnectionSetupHeader ()
{
}

TypeId
D2DConnectionSetupHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::D2DConnectionSetupHeader")
    .SetParent<Header> ()
  ;
  return tid;
}
...
void
D2DConnectionSetupHeader::Print (std::ostream &os) const
{
  os << "MMEC:" << m_mmec << std::endl;
  os << "MTMSI:" << m_mTmsi << std::endl;
  os << "Spare: " << m_spare << std::endl;
...
void
D2DConnectionSetupHeader::PreSerialize () const
{
  m_serializationResult = Buffer ();
...
uint32_t
D2DConnectionSetupHeader::Deserialize (Buffer::Iterator bIterator)
{
  std::bitset<1> dummy;
  std::bitset<0> optionalOrDefaultMask;
  int selectedOption;
...
void
D2DConnectionSetupHeader::SetMessage (LteRrcSap::D2DConnectionSetup msg)
{
  m_mTmsi = std::bitset<32> ((uint32_t)msg.rnti);
  m_mmec = std::bitset<8> ((uint32_t)(msg.rnti >> 32));
  m_isDataSerialized = false;
}

LteRrcSap::D2DConnectionSetup
D2DConnectionSetupHeader::GetMessage () const
{
  LteRrcSap::D2DConnectionSetup msg;
  msg.rnti = (((uint64_t) m_mmec.to_ulong ()) << 32) | (m_mTmsi.to_ulong ());

  return msg;
}

std::bitset<8>
D2DConnectionSetupHeader::GetMmec () const
{
  return m_mmec;
}

std::bitset<32>
D2DConnectionSetupHeader::GetMtmsi () const
{
  return m_mTmsi;
}
