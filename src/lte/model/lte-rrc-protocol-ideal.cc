...
//*********************************************************************************************************************
void 
LteUeRrcProtocolIdeal::DoSendD2DConnectionRequest (LteRrcSap::D2DConnectionRequest msg)
{
...
//********************************************************************************************************************************************
void 
LteEnbRrcProtocolIdeal::DoSendD2DConnectionSetup (uint16_t rnti, LteRrcSap::D2DConnectionSetup msg)
{
  NS_LOG_UNCOND("LteEnbRrcProtocolReal::DoSendD2DConnectionSetup");
}
//********************************************************************************************************************************************
