...
LteUeRrcProtocolReal::DoSendRrcConnectionRequest (LteRrcSap::RrcConnectionRequest msg)
{
  ...
  std::cout<< "LteUeRrcProtocolReal::DoSendRrcConnectionRequest()" << std::endl;
...
//*********************************************************************************************************************
void 
LteUeRrcProtocolReal::DoSendD2DConnectionRequest (LteRrcSap::D2DConnectionRequest msg)
{
  

  Ptr<Packet> packet = Create<Packet> ();
  D2DConnectionRequestHeader d2dConnectionRequestHeader;
  d2dConnectionRequestHeader.SetMessage (msg);

  packet->AddHeader (d2dConnectionRequestHeader);
  ...
  std::cout<< "LteUeRrcProtocolReal::DoSendD2DConnectionRequest()" << std::endl;
...
//*********************************************************************************************************************
  RrcUlDcchMessage rrcUlDcchMessage;
  packet->PeekHeader (rrcUlDcchMessage);
  //std::cout<< "LteUeRrcProtocolReal::DoSendRrcConnectionSetupCompleted()  messageid : " <<rrcUlDcchMessage.GetMessageType ()<< std::endl;
//*********************************************************************************************************************
...
LteUeRrcProtocolReal::DoReceivePdcpPdu (Ptr<Packet> p)
{
    ...
    //NS_LOG_UNCOND("LteUeRrcProtocolReal::DoReceivePdcpPdu ");
...
//*********************************************************************************************************************  
   ...
   LteRrcSap::D2DConnectionSetup d2dConnectionSetupMsg;
//*********************************************************************************************************************
  ...
  // NS_LOG_UNCOND("LteUeRrcProtocolReal::DoReceivePdcpSdu() ::  "  << rrcDlDcchMessage.GetMessageType() );
...
//*********************************************************************************************************************
      case 14:
         params.pdcpSdu->RemoveHeader (d2dConnectionSetupHeader);
         d2dConnectionSetupMsg = d2dConnectionSetupHeader.GetMessage ();
         m_ueRrcSapProvider->RecvD2DConnectionSetup (d2dConnectionSetupMsg);
      break;
//*********************************************************************************************************************
    }
}
...
//********************************************************************************************************************************************
void 
LteEnbRrcProtocolReal::DoSendD2DConnectionSetup (uint16_t rnti, LteRrcSap::D2DConnectionSetup msg)
{
  NS_LOG_UNCOND("LteEnbRrcProtocolReal::DoSendD2DConnectionSetup -- rnti:" << rnti);
  Ptr<Packet> packet = Create<Packet> ();

  D2DConnectionSetupHeader d2dConnectionSetupHeader;
  d2dConnectionSetupHeader.SetMessage (msg);

  packet->AddHeader (d2dConnectionSetupHeader);
...
//********************************************************************************************************************************************
  ...
  //std::cout<<"LteEnbRrcProtocolReal::DoReceivePdcpPdu() messageid: " << rrcUlCcchMessage.GetMessageType ()<<std::endl;
...
//********************************************************************************************************************************************
      case 17:
      p->RemoveHeader (d2dConnectionRequestHeader);
      LteRrcSap::D2DConnectionRequest d2dConnectionRequestMsg;
      d2dConnectionRequestMsg = d2dConnectionRequestHeader.GetMessage ();
      m_enbRrcSapProvider->RecvD2DConnectionRequest (rnti,d2dConnectionRequestMsg);
      break;
//********************************************************************************************************************************************
    }
}
...
LteEnbRrcProtocolReal::DoReceivePdcpSdu (LtePdcpSapUser::ReceivePdcpSduParameters params)
{
  ...
  //std::cout<<"LteEnbRrcProtocolReal::DoReceivePdcpSdu(ReceivePdcpSduParameters) messageid: " << rrcUlDcchMessage.GetMessageType ()<<std::endl;
  ...
  switch ( rrcUlDcchMessage.GetMessageType () )
    ...
    case 4:
      ...
      break;
      case 13:
        params.pdcpSdu->RemoveHeader (d2dConnectionRequestHeader);
        d2dConnectionRequestMsg = d2dConnectionRequestHeader.GetMessage ();
        m_enbRrcSapProvider->RecvD2DConnectionRequest (params.rnti, d2dConnectionRequestMsg);
      break;
    }
}
