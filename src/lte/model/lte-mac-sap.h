...
public:
  ...
  {
    TransmitPduParameters():D2DFlag(false),targetRnti(0){}
  ...
  //************************************************
    bool D2DFlag; /**< identification of D2D packet */
    uint16_t targetRnti; /**< the targeted D2D rnti */
  //************************************************
  };
...
void EnbMacMemberLteMacSapProvider<C>::TransmitPdu (TransmitPduParameters params)
{
  ...
  //std::cout << "EnbMacMemberLteMacSapProvider<C>::TransmitPdu:" << params.D2DFlag << " rnti:" << params.rnti << std::endl;
