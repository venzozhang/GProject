...
//D2D
  ...
  struct D2DConnectionRequest
  {
    uint64_t dstUeIdentity;
  };

   struct D2DConnectionSetup
  {
    // uint16_t rnti;
    uint64_t rnti;
  };
...
//********************************************************************************************************************
    virtual void SendD2DConnectionRequest (D2DConnectionRequest msg) = 0;
...
//*********************************************************************************************************************
  virtual void RecvD2DConnectionSetup (D2DConnectionSetup msg) = 0;
//*********************************************************************************************************************
...
//********************************************************************************************************************************************
  ...
  virtual void SendD2DConnectionSetup (uint16_t rnti, D2DConnectionSetup msg) = 0;
//********************************************************************************************************************************************
...
public:
  ...
  virtual void  RecvD2DConnectionRequest(uint16_t rnti,
                                         D2DConnectionRequest msg) = 0;
...
public:
  ...
  //*********************************************************************************************************************
  virtual void SendD2DConnectionRequest (D2DConnectionRequest msg) ;
  //*********************************************************************************************************************
...
template <class C>
void
MemberLteUeRrcSapUser<C>::SendD2DConnectionRequest (D2DConnectionRequest msg)
{
  
  m_owner->DoSendD2DConnectionRequest (msg);
}
//*********************************************************************************************************************
...
//*********************************************************************************************************************
  virtual void RecvD2DConnectionSetup (D2DConnectionSetup msg);
//*********************************************************************************************************************
...
template <class C>
void
MemberLteUeRrcSapProvider<C>::RecvD2DConnectionSetup (D2DConnectionSetup msg)
{
  Simulator::ScheduleNow (&C::DoRecvD2DConnectionSetup, m_owner, msg);
}
...
//********************************************************************************************************************************************
  virtual void SendD2DConnectionSetup (uint16_t rnti, D2DConnectionSetup msg);
//********************************************************************************************************************************************
...
template <class C>
void
MemberLteEnbRrcSapUser<C>::SendD2DConnectionSetup (uint16_t rnti, D2DConnectionSetup msg)
{
  m_owner->DoSendD2DConnectionSetup (rnti, msg);
}
//********************************************************************************************************************************************
...
public:
  ...
  //********************************************************************************************************************************************
  virtual void RecvD2DConnectionRequest (uint16_t rnti, D2DConnectionRequest msg);
//********************************************************************************************************************************************
...
template <class C>
void
MemberLteEnbRrcSapProvider<C>::RecvD2DConnectionRequest (uint16_t rnti, D2DConnectionRequest msg)
{
  Simulator::ScheduleNow (&C::DoRecvD2DConnectionRequest, m_owner, rnti, msg);
}
//********************************************************************************************************************************************
