...
public:
  ...
  /**
   ...
   +* \param targetRnti
   */
  void SetTargetRnti(uint16_t targetRnti);
...
protected:
  ...
  virtual void DoTransmitPdcpSdu (Ptr<Packet> p);  //+++++++++++++++++before was (Ptr<Packet> p) *

  LtePdcpSapUser* m_pdcpSapUser;
  LtePdcpSapProvider* m_pdcpSapProvider;

  // Interface provided to lower RLC entity
  virtual void DoReceivePdu (Ptr<Packet> p);  //+++++++++++++++++++before was (Ptr<Packet> p) *
