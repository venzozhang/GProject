...
public:
  ...
  {
    TransmitPdcpSduParameters():D2DFlag(false),targetRnti(0){}
    ...
    //***********************************************************************************************************
    bool        D2DFlag; /**< ++++++++++identify the d2d data */
    uint16_t    targetRnti; /**< ++++++++++the target d2d rnti */
    //***********************************************************************************************************
  };
...
public:
  ...
  {
    ReceivePdcpSduParameters():D2DFlag(false){}
    Ptr<Packet> pdcpSdu;  /**< the RRC PDU */
    uint16_t    rnti; /**< the C-RNTI identifying the UE */
    uint8_t     lcid; /**< the logical channel id corresponding to the sending RLC instance */
...
{
  m_pdcp->SetTargetRnti(params.targetRnti);
  m_pdcp->SetD2DMode(params.D2DFlag);
  m_pdcp->SetRnti(params.rnti);
  //std::cout << "rrc->pdcp" << std::endl;
  m_pdcp->DoTransmitPdcpSdu (params.pdcpSdu); //++++++++++* before was (params.pdcpSdu)*
}
