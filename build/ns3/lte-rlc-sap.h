...
public:
  ...
  {
    TransmitPdcpPduParameters():targetRnti(0),D2DFlag(false){}
...
{
  //std::cout<<"LteRlcSpecificLteRlcSapProvider flag:"<< params.D2DFlag <<std::endl;
  /*********************************************************/
  m_rlc->SetRnti(params.rnti);
  m_rlc->SetTargetRnti(params.targetRnti);
  //m_rlc->SetLcid(params.lcid);
  m_rlc->SetD2DMode(params.D2DFlag);
  /*********************************************************/
  m_rlc->DoTransmitPdcpPdu (params.pdcpPdu);

   // NS_LOG_UNCOND("LteRlcSpecificLteRlcSapProvider  " << params.D2DFlag);
...
{
  //std::cout << "LteRlcSpecificLteRlcSapUser<C>::ReceivePdcpPdu" << std::endl;
