...
//*****************************************************************************************************************
class D2DConnectionRequestHeader : public RrcUlDcchMessage
{
public:
  D2DConnectionRequestHeader ();
  ~D2DConnectionRequestHeader ();
   ...
   * @param msg The information element to parse
   */
  void SetMessage (LteRrcSap::D2DConnectionRequest msg);

  /**
   * Returns a RrcConnectionRequest IE from the values in the class attributes
   * @return A RrcConnectionRequest, as defined in LteRrcSap
   */
  LteRrcSap::D2DConnectionRequest GetMessage () const;
...
class D2DConnectionSetupHeader : public RrcUlDcchMessage
{
public:
  D2DConnectionSetupHeader ();
  ~D2DConnectionSetupHeader ();
   ...
   * @param msg The information element to parse
   */
  void SetMessage (LteRrcSap::D2DConnectionSetup msg);

  /**
   * Returns a RrcConnectionRequest IE from the values in the class attributes
   * @return A RrcConnectionRequest, as defined in LteRrcSap
   */
  LteRrcSap::D2DConnectionSetup GetMessage () const;
